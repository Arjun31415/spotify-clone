...
function Premium() {
	...
	return (
		<div className="font-sans">
			{/* Rupee symbol */}
			<section className={`${styles.container} bg-paleYellow justify-center `}>
				<div className={`flex justify-center ${styles.container}`}>
					<div className={`${styles.flexItemLeft} flex-col flex`}>
						...
						<span className="flex py-5 justify-start">
							<button
								className={
									...
									(clicked1 === true ? "border-white" : "border-transparent")
								}
							...
							<button
								className={
									...
									px-5 py-2 active:border-white 
									active:border-4 border-4 hover:scale-105 ` +
									(clicked2 === true ? "border-white" : "border-transparent")
								}
						...
						<p className="items-center">
							<small className="flex" style={{ maxWidth: "300px" }}>
					...
					<div className={`${styles.flexItemRight}`} style={{ width: "450px" }}>
						<Image
